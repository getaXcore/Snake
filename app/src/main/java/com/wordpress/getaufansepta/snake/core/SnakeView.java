package com.wordpress.getaufansepta.snake.core;
...
import com.wordpress.getaufansepta.snake.activity.Snake;
...
public class SnakeView extends TileView {
    ...
    private static final int TILE_HEAD = 4;
    ...
    private void initSnakeView() {
        ...
        loadTile(TILE_HEAD, r.getDrawable(R.drawable.minisnakeicon));
    ...
    public void initNewGame(long mMoveDelay) {
        mSnakeTrail.clear();
        mAppleList.clear();
    ...
    public void update() {
        if (mMode == RUNNING) {
            ...
            //set & display text score
            Snake.txtscore.setText(String.valueOf(mScore));
        }
